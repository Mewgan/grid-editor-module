        ...
        self.each(function (baseIndex, baseElem) {
            ...
            function createColControls() {
                canvas.find('.column').each(function () {
                    ...
                    createDropdownTools(settings.col_tools,drawer);
                   ...
                   /* settings.col_tools.forEach(function (t) {
                    ...
                    createTool(drawer, 'Remove col', 'ge-remove-row', 'glyphicon-trash', function () {
                        col.animate({
                            opacity: 'hide',
                            width: 'hide',
                            height: 'hide'
            ...
            function createDropdownTools(list, drawer) {
                var tools = $(`<div class="btn-group tools-list">
                    <div class="btn-group">
                ...
                list.forEach(function(t) {
                    var tool = $('<li><a title="' + t.title + '" class="' + t.className + '"><i class="' + t.iconClass + '"></i>' + t.title + '</a></li>')
                            .appendTo(tools.find('.dropdown-menu'))
                        ;
                    var eventHandlers = t.on;
                    if (typeof eventHandlers == 'function') {
                        tool.find('a').on('click', eventHandlersn);
                    }
...
(function () {
    $.fn.gridEditor.RTEs.ckeditor = {
        ...
        initialContent: '<p>Ajouter votre contenu ici</p>',
    }
})();
(function () {
